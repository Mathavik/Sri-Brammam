...
const EventsPage: React.FC = () => {
  ...
  return (
    <div className="py-10" style={muktaStyle}>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-10 grid gap-6 p-6 lg:grid-cols-[1.3fr_0.9fr]">
          ...
          <div className="relative flex items-center justify-center overflow-hidden p-6 shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-slate-100 rounded-[32px]">
            <div className="relative z-10 flex h-full w-full flex-col justify-between gap-6">
              <div>
                ...
                <h3 className="text-2xl font-semibold leading-tight text-slate-900">தமிழ் எழுத்து மற்றும் நிகழ்ச்சிகள்</h3>
              </div>
              <div className="grid gap-4">
                <div className="rounded-[24px] border border-slate-100 p-4 shadow-sm">
