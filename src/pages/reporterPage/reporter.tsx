// MOBILE RESPONSIVE + API + WRITER TAB SUPPORT FIXED
...
const Reporter: React.FC<ReporterProps> = () => {
  ...
  const [selectedReporterId, setSelectedReporterId] =
    useState<number | null>(null);

  const [reporters, setReporters] = useState<ReporterItem[]>([]);

  const [personsData, setPersonsData] =
    useState<TeamData>({
      senior: [],
      junior: [],
    });
  ...
  return (
    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-8 md:py-10 min-h-screen mt-16 md:mt-52">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-[#932725] font-bold animate-pulse">
          ...
          <section>
            ...
            {personsData.senior.length > 0 ? (
              ...
              <div className="text-center py-16 border-2 border-dashed border-[#D9CEB2] rounded-2xl bg-gray-50">
                ...
                <p className="text-[#6C5F47] font-medium">

                  தகவல்கள் எதுவும் இல்லை (No Data Found)
