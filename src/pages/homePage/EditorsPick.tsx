      ...
      <div className="w-full bg-white pt-16 pb-2">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative px-6 md:px-24">
            {/* Desktop-la mattum arrows theriyum */}
            <button
              onClick={scrollLeft}
            ...
            {/* Container: Mobile-la flex-col (stack), Desktop-la flex-row (horizontal scroll) */}
            <div
              ref={scrollRef}
            ...
            >
              {editorsPicks.map((item) => (
                <div
                  ...
                  /* width logic: Mobile-la full width, desktop-la 3 columns */
